...
public class EscWindow : WindowBase
{
    // UI面板的组件类
    public EscWindowDataComponent dataCompt;
    ...
    {
        dataCompt = gameObject.GetComponent<EscWindowDataComponent>();
    ...
    public void OnCloseButtonClick()
    {
        ...
        HideWindow();
        GameManager.Instance.IsShowEscWindow = false;
    }
